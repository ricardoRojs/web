...
class Pagos{
    ...
    function sendMailCliente($datos){
        ...
        try {
            ...
            $mail->addAddress($datos['correo'], $datos['nombre']." ".$datos['apellido'] );   // Add a recipient
            ...
            $mensaje =
                ...
                "Para atención de reclamos puede comunicarse al (01) 271-0852 o escribirnos a contactos@gis-sac.com, tambien puede <a href='https://web.gis-sac.com/contactar'>Contactarnos</a>".
                "</p><br>".
                "</td>".
                "<td width='15%'></td>".
                "</tr>".
